                ...
                <div class="card_container" >
                    ...
                    >
                        <el-carousel-item
                                ...
                                v-for="item in 4" :key="item" class="carousel">
                            <Bio style="width: 100%;"></Bio>
                        </el-carousel-item>
                    </el-carousel>
                </div>
            </template>
            <img class="like-pointer" slot="like" src="../assets/like-txt.png" style="z-index: 1000;">
            <img class="nope-pointer" slot="nope" src="../assets/nope-txt.png" style="z-index: 1000;">
            <img class="super-pointer" slot="super" src="../assets/super-txt.png" style="z-index: 1000;">
            <img class="rewind-pointer" slot="rewind" src="../assets/rewind-txt.png" style="z-index: 1000;">
        </Tinder>
        <div class="btns">
